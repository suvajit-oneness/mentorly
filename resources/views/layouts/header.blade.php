<header>
    ...
    <div class="container">
        <div class="inner-header">
            ...
            <div class="nevigation justify-content-end">
                <div class="menu-wrap">
                    <div class="closeHam" onclick="closeHam()">
                       <i>X</i>
                    </div>
                    <ul class="menu">
                        ...
                        @endif
                        <li><a href="{{route('carrier')}}">Career</a></li>
                    ...
                    <div class="header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <ul class="profile-dropdown">
                                ...
                                @endif
                                <li><a href="{{route('invite.friends')}}">Invite a friend </a></li>
                ...
                @else
                    <ul class="menu-btm d-flex justify-content-end flex-column flex-sm-row">
                ...
                @endif
                <div class="ham ml-2" onclick="openHam()">
                    <span></span>
                    <span></span>
                    <span></span>
                    ...
                    <script>
                        function openHam() {
                            document.querySelector(".menu-wrap").style.transform = "translate(0)";
                        }

                        function closeHam() {
                            document.querySelector(".menu-wrap").style.transform = "translate(100%)";
                        }
                    </script>
