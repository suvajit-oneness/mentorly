                ...
                <form action="{{ route('admin.news.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('name') is-invalid @enderror" type="text" name="title" id="title" value="{{ old('name', $targetNews->title) }}"/>
                                ...
                                <div class="col-md-2">
                                    @if ($targetNews->image != null)
                                        <figure class="mt-2" style="width: 80px; height: auto;">
                                            <img src="{{ asset('news/'.$targetNews->image) }}" id="blogImage" class="img-fluid" alt="img">
                                        </figure>
                                    @endif
                                </div>
                                <div class="col-md-10">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" type="text" name="description" id="description" >{{ old('name', $targetNews->description) }}</textarea>
