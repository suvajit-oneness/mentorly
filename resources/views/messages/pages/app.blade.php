	...
	<div class="container">
		<div class="setting-wrapper">
			<div class="row m-0 mt-5">
                ...
                <div class="col-12 col-md-14 pl-2 pl-md-5">
                    <title>{{ config('chatify.name') }}</title>
                    {{-- Meta tags --}}
                    <meta name="viewport" content="width=device-width, initial-scale=1">
                    {{-- <meta name="route" content="{{ $route }}"> --}}
                    <meta name="csrf-token" content="{{ csrf_token() }}">
                    <meta name="url" content="{{ url('').'/'.config('chatify.routes.prefix') }}" data-user="{{ Auth::guard(get_guard())->user()->id }}">

                    {{-- scripts --}}
                    <script
                    src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
                    <script src="{{ asset('message/js/font.awesome.min.js') }}"></script>
                    <script src="{{ asset('message/js/autosize.js') }}"></script>
                    <script src='https://unpkg.com/nprogress@0.2.0/nprogress.js'></script>

                    {{-- styles --}}
                    <link rel='stylesheet' href='https://unpkg.com/nprogress@0.2.0/nprogress.css'/>
                    <link href="{{ asset('message/css/style.css') }}" rel="stylesheet" />
                    {{-- <link href="{{ asset('message/css/'.$dark_mode.'.mode.css') }}" rel="stylesheet" /> --}}

                    {{-- Messenger Color Style--}}
                    @include('messages.layouts.messengerColor')
                    {{-- HeaderLinks end --}}
                    <div class="messenger">
                        ...
                        <div class="messenger-listView">
                            ...
                            <div class="show messenger-tab app-scroll" data-view="users">
                                ...
                                {{-- {!! view('messages.layouts.listItem', ['get' => 'saved','id' => $id])->render() !!} --}}
                        ...
                        <div class="messenger-infoView app-scroll">
                            ...
                            {!! view('messages.layouts.info')->render() !!}
                        </div>
                    </div>

                    {{-- @include('Chatify::layouts.modals') --}}
                    @include('messages.layouts.modals')
                    {{-- @include('Chatify::layouts.footerLinks') --}}
                    {{-- @include('messages.layouts.footerLinks') --}}
                    <script src="{{ asset('message/js/code.js') }}"></script>
